...
class Permission extends Model
{
    ...
    protected static array $permissions = [
        ...
        // Controls permissions for the server's public subdomain.
        'subdomain' => [
            'description' => 'Permissions that control a user\'s ability to manage the public subdomain pointing at this server.',
            'keys' => [
                'read' => 'Allows a user to view the subdomain assigned to this server.',
                'create' => 'Allows a user to claim a subdomain for this server.',
                'delete' => 'Allows a user to release the subdomain assigned to this server.',
            ],
        ],
